...
\newcommand{\tofix}[1]{{\color{JungleGreen}{(#1)}}}
...
\addbibresource{ref/allbib.bib}
\addbibresource{ref/mixt.bib}
\addbibresource{ref/democut.bib}
\addbibresource{ref/demowiz.bib}
\addbibresource{ref/kinectograph.bib}
\addbibresource{ref/demodraw.bib}
...
\degreesemester{(Draft -- latest update: \today)\\Summer}
\degreeyear{2016}
\degree{Doctor of Philosophy}
\chair{Professor Bj\"orn Hartmann}
\othermembers{Professor Eric Paulous \\
...
\include{chap2_background/background}
\include{\mixt/mixt}
