...
\begin{figure*}[!hb]
  \centering
  \includegraphics[width=0.8\textwidth]{\conclusion/fig/non_linear/tutorial_link}
  \caption{
...
\begin{figure*}[t!]
  \centering
  \includegraphics[width=0.47\textwidth]{\conclusion/fig/ar_authoring/motionbuilding1}
  \includegraphics[width=0.47\textwidth]{\conclusion/fig/ar_authoring/motionbuilding2}
  \caption{
