...
\begin{figure*}[h!]
  \centering
  \includegraphics[width=0.6\textwidth]{\conclusion/fig/non_linear/main}
  \includegraphics[width=0.6\textwidth]{\conclusion/fig/non_linear/branch}
  \caption{
    Online instructions often include external links (top) to other material (bottom), which enhances or expands a step-by-step tutorial. Example by Jeff Suovanen~\cite{iPhoneRepairExample}, licensed under CC BY 2.0.
  }
...
%
The first element, \emph{making}, considers how authors master an instructional topic to perform a task. In this dissertation, we target at authors who are the domain experts that well know the tasks. It could be interesting to also supports amateurs or novices that are less familiar a task workflow but want to capture their creating process, such as mimicking experts' patterns~\cite{Kim:2015:MSN:2702123.2702507}.
%
The second element, \emph{teaching}, considers how authors illustrate a task to help learners follow. Our work attempts to suggest tutorial presentation formats to help authors focus on performing their demonstrations. As instructors have preferred styles of teaching, future authoring tools can include customization (e.g., video templates with specific opening and effects, or illustration styles with favorite visual parameter settings) and material reuse (e.g., including the successful parts of other instructions). Learners can also possibly define their preferences, such as automatically slowing down or replaying a video for unfamiliar parts~\tofix{citation here}.
%
The third element, \emph{editing}, considers how authors compose the instructional material into a final form, such as a video or a static tutorial. Our tools focus on automating this aspect for authors who are not professional in editing. We see the values that the results of our work can be used for advanced editing, such as exporting to conventional video or graphics editing tools.
%
