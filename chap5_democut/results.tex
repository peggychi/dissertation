...
\subsubTitleBold{DemoCut interface and workflow}
...
\subsubTitleBold{Automatic editing effects} In general, the participants
...
\subsubTitleBold{Reviewing and editing} As expected, there were some cases where
...
\subsubTitleBold{Quality of generated tutorials} Five of the eight
...
\subsubTitleBold{Default speed-up effects} The participants noted some limitations
...
\subsubTitleBold{Annotation guidelines} One observation from the study is that
