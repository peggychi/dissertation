...
segment boundaries (Figure~\ref{fig:pipeline}). DemoCut then automatically applies an temporal and a visual effect to
...
\begin{figure}[t]
  \centering
\includegraphics[width=1\columnwidth]{\democut/fig/pipeline}
...
\begin{figure}[t]
  \centering
\includegraphics[width=1.0\columnwidth]{\democut/fig/video-similarity}
...
\begin{figure}[t]
  \centering
\includegraphics[width=1.0\columnwidth]{\democut/fig/audio}
...
\begin{table*}
  ...
  \begin{tabular}{|l*{11}{|c}|}
    \hline
    \multicolumn{1}{|p{0.3\columnwidth}|}{\centering\tabhead{Task}} &
    \multicolumn{1}{|p{0.1\columnwidth}|}{\centering\tabhead{Category}} &
    \multicolumn{1}{|p{0.1\columnwidth}|}{\centering\tabhead{Raw footage length}} &
    \multicolumn{1}{|p{0.13\columnwidth}|}{\centering\tabhead{DemoCut video length}} &
    \multicolumn{1}{|p{0.12\columnwidth}|}{\centering\tabhead{\# of markers}} &
    \multicolumn{1}{|p{0.1\columnwidth}|}{\centering\tabhead{\# of segments}} &
    \multicolumn{1}{|p{0.12\columnwidth}|}{\centering\tabhead{Incorrect Effects}} &
    \multicolumn{1}{|p{0.15\columnwidth}|}{\centering\tabhead{\# of non-silent sections}} &
    \multicolumn{1}{|p{0.1\columnwidth}|}{\centering\tabhead{Audio misses}} &
    \multicolumn{1}{|p{0.1\columnwidth}|}{\centering\tabhead{Audio cut-off}} &
    \multicolumn{1}{|p{0.1\columnwidth}|}{\centering\tabhead{Audio false-positives}} \\ \hline
