...
\end{itemize}
% \bh{This list takes up a lot of space.}\pc{shorten}
...
20 videos from 20 distinct authors were coded in a week. Figure \ref{fig:formative} presents selected examples; Table~\ref{tab:democut_formative} in the Appendix preserves detailed information.
...
% https://docs.google.com/spreadsheet/ccc?key=0Ak-N9HjmbtiYdGhYVXNWdkVwWU9MUTNZZU5kQmRyNUE#gid=0
...
% \jl {I don't know if saying "one interrupted take" is completely accurate because sometimes the authors would just have many takes of an action until they got it right, and then part of the issue they encountered during editing is finding the *right* clips that they wanted after importing their footage into the video editing software. Nonetheless, I think how we can frame this is that Peggy's system offers a new way to think about filming AND editing--people shouldn't have to worry about messing up because later on it will be easy to take out their mistakes, and they don't have to go through the pain of going through all the clips to find the right one. Assuming that by the end they eventually get it right on the last try, they can just basically delete the footage that had the mistakes before up uptil the previous step. The more that I think about it, I think what's great about the system is that it matches more of the conceptual model of the author when s/he thinks about creating the video—it should be just one streamlined process/take, and this system takes the load off of thinking about restarting the camera/filming so that the author can just focus on performing/teaching his/her craft.}
...
interesting. P2 described his strategy as follows: \iquote{If you
  can get rid of it and the video content still gets through, get rid
  of it}; \iquote{The way to make your video sizzle is to have good
  cuts, good points.} As a result, authors spend much of their editing
...
subtitles and annotations. As P4 explained, \iquote{the filming is the
