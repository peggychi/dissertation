...
\begin{figure}[t]
  \centering
\includegraphics[width=1.0\columnwidth]{\democut/fig/formative-videostills}
...
20 videos from 20 distinct authors were coded in a week (Figure \ref{fig:formative}).
