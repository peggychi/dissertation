%!TEX root = ../thesis.tex
\chapter{Instructional Videos from Physical Demonstrations}
...
\input{\democut/intro}
\input{\democut/related_work}
\input{\democut/formative_study}
\input{\democut/goals}
\input{\democut/democut_overview}
\input{\democut/automatic_effects}
\input{\democut/implementation}
\input{\democut/system_results}
\input{\democut/evaluation}
\input{\democut/results}
\input{\democut/futurework_conclusion}
