...
\begin{figure*}[h!]
  ...
  %
  c) Year 2014: An animation shows motion arrows to visualize the blood flow (Video by Bioscience Credentials, ``Blood Flow in the Human Body'', licensed under CC BY 3.0).
  }
...
%
To combine the benefits of videos and static tutorial formats, I design a new instructional presentation called \emph{MixT} (mixed-media tutorials) that improves learners' success in following instructions (see Figure~\ref{fig:mixt_intro}).
%
...
\begin{figure*}[t]
  ...
  \caption{DemoCut asks authors to mark key moments in a recorded video of demonstration using a set of marker types. Based on marker information, the system uses audio and video analysis to automatically organize the video into meaningful segments and apply appropriate video editing effects. A playback UI provides lightweight editing for authors to review and modify automatic results.}
