...
Some of these systems require a high-speed camera~\cite{Okumura:2011tr} or a depth camera~\cite{Gupta:2012ku,Wilson:2012fb,Anderson:2013:YEM:2501988.2502045,dou-siggraph2016}, while some require users to wear reflective markers that can be seen by a camera~\cite{Ranjan:2008}.
%
...
% for *some* types of physical tasks. What’s the insight behind workflow capture or bloack assembly tasks that makes the tracking possible?  Overall, this paragraph is too short. I don’t yet learn about the principles or challenges of this work. Also, the tracking in the next paragraph seems to also be relevant for this paragraph. So this section needs expansion and a bit more careful thinking about the arguments you want to present.
...
Figure~\ref{fig:related_teleadvisor}
%
...
\begin{figure*}[t!]
  \centering
  \includegraphics[width=0.4\textwidth]{\background/fig/teleadvisor/authoring}
  \includegraphics[width=0.41\textwidth]{\background/fig/teleadvisor/following}
