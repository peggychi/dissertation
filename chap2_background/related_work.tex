...
\begin{itemize}
  \item Tracking objects. Common approaches include 1) tracking colors of pre-defined objects, such as a fast-moving Ping-Pong ball for automatic camera control~\cite{Okumura:2011tr} or blocks for assembly tasks~\cite{Gupta:2012ku}, and 2) tracking motion-capture markers, such as an animator to create continuous movements~\cite{Dontcheva:2003:LAC:1201775.882285}.
