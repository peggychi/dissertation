...
\begin{figure*}[th!]
  \centering
  \includegraphics[width=0.8\textwidth]{\background/fig/scripts/scripts}
...
% B: One question as I read this: Do authors perform only once? In many other media production pipelines, this is an iterative process - write a draft, then improve it; record a shot, critique it, maybe re-record if necessary.
