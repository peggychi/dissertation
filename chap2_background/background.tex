...
\begin{itemize}
  ...
  \item Books of illustrating technical instructions and user experiences~\cite{mijksenaar1999open,greenberg2012sketching,Buxton:2007:SUE:1526229}.
\end{itemize}
...
Following instructions can be an intense process for a learner, especially when performing unfamiliar, complicated tasks. Therefore, tutorial authors have to carefully provide concise, effective instructions that can be interpreted by a follower efficiently. A set of techniques has been developed and widely used in technical and everyday instructions~\cite{mijksenaar1999open,greenberg2012sketching,Buxton:2007:SUE:1526229}.

\subsection{Visual Annotations}

Static, step-by-step instructions are composed of one or more figures, often with text descriptions. To help learners identify the key information, visual annotations are commonly applied to figures.
%
Table~\ref{background_techniques} shows a list of annotation techniques in practices that I summarized from book material~\cite{mijksenaar1999open,greenberg2012sketching,Buxton:2007:SUE:1526229}. The visual elements are used to indicate the movements of actions or objects (via arrows or paths), identify important parts (via highlights), present the details and overview (via call-outs), and provide high-level
