...
Following instructions can be an intense process for a learner, especially for unfamiliar, complicated tasks. To create effective tutorials that are easy to comprehend, a set of techniques has been developed and is widely used~\cite{mijksenaar1999open,greenberg2012sketching,Buxton:2007:SUE:1526229}.
...
\begin{figure*}[t!]
  ...
  \caption{\tofix{present and discuss techniques here}}
