...
%
Specifically, Tufte~\cite{tufte1990envisioning} pointed out the importance of ... [the fig from p63 here]
...
Video tutorials are composed of a series of image frames into ``shots'' to provide the animation or capturing of movements in time.
%
Time can be manipulated by jumping between shots, applying transitions, or being fast-forward or slowdown.

Annotation techniques of static instructions can be used in video tutorials, such as applying arrows, paths, highlights, call-outs, and text.
%
Subtitles
%
auditory effects

% https://www.youtube.com/watch?v=p6MzLXeWBJw
