%!TEX root = ../thesis.tex
\chapter{Visualization for Software Demonstrations}
...
\input{\demowiz/intro}
\input{\demowiz/related_work}
\input{\demowiz/design}
\input{\demowiz/system}
\input{\demowiz/evaluation}
\input{\demowiz/discussion}
\input{\demowiz/conclusion}
