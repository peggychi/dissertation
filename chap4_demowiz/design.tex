...
\subsubTitleBold{G1. Show what's coming next, where and when it will occur.}
...
\subsubTitleBold{G2. Minimize required attention or interpretation.}
...
\subsubTitleBold{G3. Support light-weight editing during rehearsal.}
